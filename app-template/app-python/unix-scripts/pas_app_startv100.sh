...
nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_NORMAL_MEMORY $(($PAS_STONE_NORMAL_PORT + 00)) pas_normal.0  >/dev/null 2>&1 &
#nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_NORMAL_MEMORY $(($PAS_STONE_NORMAL_PORT + 10)) pas_normal.1  >/dev/null 2>&1 &
#nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_NORMAL_MEMORY $(($PAS_STONE_NORMAL_PORT + 20)) pas_normal.2  >/dev/null 2>&1 &
#nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_NORMAL_MEMORY $(($PAS_STONE_NORMAL_PORT + 30)) pas_normal.3 >/dev/null 2>&1 &
#nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_NORMAL_MEMORY $(($PAS_STONE_NORMAL_PORT + 40)) pas_normal.4  >/dev/null 2>&1 &
fi

if [ "$PAS_APP_ENABLE_LONG_PORT" = "true" ]; then
nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_LONG_MEMORY $(($PAS_STONE_LONG_PORT + 00)) pas_long.0  >/dev/null 2>&1 &
#nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_LONG_MEMORY $(($PAS_STONE_LONG_PORT + 10)) pas_long.1  >/dev/null 2>&1 &
fi

if [ "$PAS_APP_ENABLE_MEMORY_PORT" = "true" ]; then
nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_MEMORY_MEMORY $(($PAS_STONE_MEMORY_PORT + 00)) pas_memory.0  >/dev/null 2>&1 &
#nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_MEMORY_MEMORY $(($PAS_STONE_MEMORY_PORT + 10)) pas_memory.1  >/dev/null 2>&1 &
fi

if [ "$PAS_APP_ENABLE_LIMITED_PORT" = "true" ]; then
nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_LIMITED_MEMORY $(($PAS_STONE_LIMITED_PORT + 00)) pas_limited.0  >/dev/null 2>&1 &
#nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_LIMITED_MEMORY $(($PAS_STONE_LIMITED_PORT + 10)) pas_limited.1  >/dev/null 2>&1 &
fi

if [ "$PAS_APP_ENABLE_EXTDB_PORT" = "true" ]; then
nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_EXTDB_MEMORY $(($PAS_STONE_EXTDB_PORT + 00)) pas_extdb.0 >/dev/null 2>&1 &
#nohup ./pas_start_http_taskv100.sh $PAS_STONE_NAME $PAS_STONE_EXTDB_MEMORY $(($PAS_STONE_EXTDB_PORT + 10)) pas_extdb.1  >/dev/null 2>&1 &
fi
######################################
