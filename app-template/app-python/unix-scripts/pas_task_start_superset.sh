...
USAGE: $(basename $0)
Dieses Skript startet den Superset Token Handler
...
$PAS_APP_SERVICE_CLASS supersetAccessTokenTask: 'local' adminLogin: '$PAS_SUPERSET_LOGIN' adminPassword: '$PAS_SUPERSET_PASSWORD'.
%
